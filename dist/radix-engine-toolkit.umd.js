(function(global2, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, factory(global2["radix-engine-toolkit"] = {}));
...
var __publicField = (obj, key, value) => {
  ...
  class CompiledSignedTransactionIntent {
    ...
    compileNotarizedInternal(notarySignature) {
      ...
      const [compiledNotarizedTransaction, notarizedPayloadHash] = (() => {
        ...
        const hash2 = GeneratedConverter.TransactionHash.fromGenerated(
          this.retWrapper.notarizedTransactionHash(input)
        );
        return [compiled, hash2];
      })();
  ...
  let Point$3 = class Point2 {
    ...
    static fromHex(hex, strict = true) {
      ...
      if (isHeadOdd !== isXOdd)
        x = mod(-x);
      return new Point2(x, y, 1n, mod(x * y));
    }
    get x() {
  ...
  const modL_LE = (hash2) => mod(b2n_LE(hash2), N);
  let _shaS;
  ...
  const _sign = (e, rBytes, msg) => {
    ...
    const R = G.mul(r2).toRawBytes();
    const hashable = concatB(R, P2, msg);
    const finish = (hashed) => {
      const S = mod(r2 + modL_LE(hashed) * s2, N);
  ...
  (function(module2) {
    (function(module3, exports3) {
      ...
      function parseBase(str2, start, end, mul2) {
        var r2 = 0;
  ...
  Point$1.prototype.add = function add2() {
  ...
  Point$1.prototype.mul = function mul2(k) {
    var t = k.clone();
    var a = this;
  ...
  Point.prototype.mul = function mul2(k) {
  ...
  HmacDRBG$1.prototype.reseed = function reseed(entropy, entropyEnc, add2, addEnc) {
    ...
    add2 = utils$6.toArray(add2, addEnc);
    assert$6(
      entropy.length >= this.minEntropy / 8,
      "Not enough entropy. Minimum is: " + this.minEntropy + " bits"
    );
  ...
  HmacDRBG$1.prototype.generate = function generate(len, enc, add2, addEnc) {
    ...
    if (add2) {
      add2 = utils$6.toArray(add2, addEnc || "hex");
      this._update(add2);
    }
    var temp = [];
  ...
  EC$1.prototype.genKeyPair = function genKeyPair(options) {
    ...
    for (; ; ) {
      var priv = new BN$2(drbg.generate(bytes2));
      if (priv.cmp(ns2) > 0)
        continue;
      priv.iaddn(1);
  ...
  KeyPair$1.prototype.sign = function sign2(message) {
  ...
  })(exports2.NetworkId || (exports2.NetworkId = {}));
  ...
  const hash = (data) => blakejs.blake2b(data, void 0, 32);
  ...
  const rawRadixEngineToolkit = wasmModule(
    ...
    const exports3 = instance.instance.exports;
    return new RawRadixEngineToolkit(exports3);
  });
  Decimal.config({ precision: 64 });
  exports2.CompiledNotarizedTransaction = CompiledNotarizedTransaction;
  exports2.CompiledSignedTransactionIntent = CompiledSignedTransactionIntent;
  exports2.Convert = Convert;
  exports2.DefaultDepositRule = DefaultDepositRule;
  exports2.ED25519_PRIVATE_KEY_LENGTH = ED25519_PRIVATE_KEY_LENGTH;
  exports2.ED25519_PUBLIC_KEY_LENGTH = ED25519_PUBLIC_KEY_LENGTH;
  exports2.ED25519_SIGNATURE_LENGTH = ED25519_SIGNATURE_LENGTH;
  exports2.EntityType = EntityType;
  exports2.Expression = Expression;
  exports2.Host = Host;
  exports2.InstructionsKind = InstructionsKind;
  exports2.LTSNotarizedTransaction = LTSNotarizedTransaction;
  exports2.LTSRadixEngineToolkit = LTSRadixEngineToolkit;
  exports2.LTSSignedTransactionIntent = LTSSignedTransactionIntent;
  exports2.LTSTransactionIntent = LTSTransactionIntent;
  exports2.ManifestBuilder = ManifestBuilder;
  exports2.ManifestSborStringRepresentation = ManifestSborStringRepresentation;
  exports2.NotImplementedException = NotImplementedException;
  exports2.OlympiaNetwork = OlympiaNetwork;
  exports2.PrivateKey = PrivateKey;
  exports2.PublicKey = PublicKey;
  exports2.RadixEngineToolkit = RadixEngineToolkit;
  exports2.RawRadixEngineToolkit = RawRadixEngineToolkit;
  exports2.ReservedInstruction = ReservedInstruction;
  exports2.ResourcePreference = ResourcePreference;
  exports2.SECP256K1_PRIVATE_KEY_LENGTH = SECP256K1_PRIVATE_KEY_LENGTH;
  exports2.SECP256K1_PUBLIC_KEY_LENGTH = SECP256K1_PUBLIC_KEY_LENGTH;
  exports2.SECP256K1_SIGNATURE_LENGTH = SECP256K1_SIGNATURE_LENGTH;
  exports2.SerializationMode = SerializationMode;
  exports2.Signature = Signature;
  exports2.SignatureWithPublicKey = SignatureWithPublicKey;
  exports2.SimpleTransactionBuilder = SimpleTransactionBuilder;
  exports2.TransactionBuilder = TransactionBuilder;
  exports2.TransactionBuilderIntentSignaturesStep = TransactionBuilderIntentSignaturesStep;
  exports2.TransactionBuilderManifestStep = TransactionBuilderManifestStep;
  exports2.ValueKind = ValueKind;
  exports2.address = address;
  exports2.addressReservation = addressReservation;
  exports2.array = array;
  exports2.blob = blob;
  exports2.bool = bool$1;
  exports2.bucket = bucket;
  exports2.castValue = castValue;
  exports2.decimal = decimal;
  exports2.defaultValidationConfig = defaultValidationConfig;
  exports2.destructManifestValueTuple = destructManifestValueTuple;
  exports2.enumeration = enumeration;
  exports2.expression = expression;
  exports2.generateRandomNonce = generateRandomNonce;
  exports2.hash = hash;
  exports2.i128 = i128;
  exports2.i16 = i16;
  exports2.i32 = i32;
  exports2.i64 = i64;
  exports2.i8 = i8;
  exports2.isAccountDepositCallMethod = isAccountDepositCallMethod;
  exports2.isAccountWithdrawCallMethod = isAccountWithdrawCallMethod;
  exports2.isFreeXrdCallMethod = isFreeXrdCallMethod;
  exports2.isLockFeeCallMethod = isLockFeeCallMethod;
  exports2.map = map;
  exports2.nonFungibleLocalId = nonFungibleLocalId;
  exports2.preciseDecimal = preciseDecimal;
  exports2.proof = proof;
  exports2.rawRadixEngineToolkit = rawRadixEngineToolkit;
  exports2.resolveBytes = resolveBytes$1;
  exports2.resolveBytesAndCheckLength = resolveBytesAndCheckLength$1;
  exports2.resolveDecimal = resolveDecimal;
  exports2.resolveSignatureSource = resolveSignatureSource;
  exports2.str = str$1;
  ...
  exports2.u64 = u64$1;
  exports2.u8 = u8;
  exports2.wasmBindgenImports = wasmBindgenImports;
